class FormValidator {
  ...
  _setEventListeners() {
    const inputList = Array.from(this._elementValidate.querySelectorAll(this._inputSelector));
  ...
  resetForm() {
    ...
    const inputs = this._elementValidate.querySelectorAll(this._inputSelector);
